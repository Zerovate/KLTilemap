...
public:
	...
	_FORCE_INLINE_ void set_noise_material(const Ref<Material> &p_material) { _noise_material = p_material; }

	_FORCE_INLINE_ Ref<Material> get_noise_material() { return _noise_material; }
	//endregion
...
protected:
	...
	/// Material for noise layer
	Ref<Material> _noise_material;
